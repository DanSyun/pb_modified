...
class PublicImportMessageLite : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool update_e() const; // == hk made
  inline void clear_e();
 ...
 private:
  inline void set_update_e();	// == hk made
...
//===================================================
public:
  inline void clear_update_e();	// == hk made
};
// ===================================================================
...
inline bool PublicImportMessageLite::update_e() const { // == hk made
...
inline void PublicImportMessageLite::set_update_e() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void PublicImportMessageLite::clear_update_e() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
