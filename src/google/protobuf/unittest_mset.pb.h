...
class TestMessageSetContainer : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_message_set() const; // == hk made
 ...
 private:
  inline void set_update_message_set();	// == hk made
...
//===================================================
public:
  inline void clear_update_message_set();	// == hk made
};
// -------------------------------------------------------------------
...
class TestMessageSetExtension2 : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_str() const; // == hk made
 ...
 private:
  inline void set_update_str();	// == hk made
...
//===================================================
public:
  inline void clear_update_str();	// == hk made
};
// -------------------------------------------------------------------
...
class RawMessageSet_Item : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_type_id() const; // == hk made
  ...
  inline bool update_message() const; // == hk made
 ...
 private:
  inline void set_update_type_id();	// == hk made
  inline void set_has_type_id();
  inline void clear_has_type_id();
  inline void set_update_message();	// == hk made
...
//===================================================
public:
  inline void clear_update_type_id();	// == hk made
  inline void clear_update_message();	// == hk made
};
// -------------------------------------------------------------------
...
//===================================================
public:
  inline void clear_update_item();	// == hk made
};
// ===================================================================
...
inline bool TestMessageSetContainer::update_message_set() const { // == hk made
...
inline void TestMessageSetContainer::set_update_message_set() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestMessageSetContainer::clear_update_message_set() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool TestMessageSetExtension1::update_i() const { // == hk made
  return (_update_bits_[0] & 0x00000001u) != 0;
}
...
inline void TestMessageSetExtension1::set_update_i() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestMessageSetExtension1::clear_update_i() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool TestMessageSetExtension2::update_str() const { // == hk made
  return (_update_bits_[0] & 0x00000001u) != 0;
}
...
inline void TestMessageSetExtension2::set_update_str() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestMessageSetExtension2::clear_update_str() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool RawMessageSet_Item::update_type_id() const { // == hk made
  return (_update_bits_[0] & 0x00000001u) != 0;
}
...
inline void RawMessageSet_Item::set_update_type_id() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void RawMessageSet_Item::clear_update_type_id() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool RawMessageSet_Item::update_message() const { // == hk made
...
inline void RawMessageSet_Item::set_update_message() { // == hk made
  _update_bits_[0] |= 0x00000002u;
}
inline void RawMessageSet_Item::clear_update_message() { // == hk made
  _update_bits_[0] &= ~0x00000002u;
}
