...
class TestOptimizedForSize : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_msg() const; // == hk made
  ...
  inline bool update_integer_field() const; // == hk made
  ...
  inline bool update_string_field() const; // == hk made
 ...
 private:
  ...
  inline void set_update_msg();	// == hk made
  inline void set_has_msg();
  inline void clear_has_msg();
  inline void set_update_integer_field();	// == hk made
  inline void set_has_integer_field();
  inline void set_update_string_field();	// == hk made
...
public:
  ...
  inline void clear_update_msg();	// == hk made
};
// -------------------------------------------------------------------
...
class TestRequiredOptimizedForSize : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_x() const; // == hk made
  inline void clear_x();
 ...
 private:
  inline void set_update_x();	// == hk made
...
//===================================================
public:
  inline void clear_update_x();	// == hk made
};
// -------------------------------------------------------------------
...
class TestOptionalOptimizedForSize : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_o() const; // == hk made
  inline void clear_o();
 ...
 private:
  inline void set_update_o();	// == hk made
...
//===================================================
public:
  inline void clear_update_o();	// == hk made
};
// ===================================================================
...
inline bool TestOptimizedForSize::update_i() const { // == hk made
...
inline void TestOptimizedForSize::set_update_i() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestOptimizedForSize::clear_update_i() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool TestOptimizedForSize::update_msg() const { // == hk made
...
inline void TestOptimizedForSize::set_update_msg() { // == hk made
  _update_bits_[0] |= 0x00000002u;
}
inline void TestOptimizedForSize::clear_update_msg() { // == hk made
  _update_bits_[0] &= ~0x00000002u;
}
...
inline bool TestRequiredOptimizedForSize::update_x() const { // == hk made
  return (_update_bits_[0] & 0x00000001u) != 0;
}
...
inline void TestRequiredOptimizedForSize::set_update_x() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestRequiredOptimizedForSize::clear_update_x() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool TestOptionalOptimizedForSize::update_o() const { // == hk made
  return (_update_bits_[0] & 0x00000001u) != 0;
}
...
inline void TestOptionalOptimizedForSize::set_update_o() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestOptionalOptimizedForSize::clear_update_o() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
