...
class ImportMessageLite : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool update_d() const; // == hk made
  inline void clear_d();
 ...
 private:
  inline void set_update_d();	// == hk made
...
//===================================================
public:
  inline void clear_update_d();	// == hk made
};
// ===================================================================
...
inline bool ImportMessageLite::update_d() const { // == hk made
...
inline void ImportMessageLite::set_update_d() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void ImportMessageLite::clear_update_d() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
