...
class TestConflictingSymbolNames : public ::google::protobuf::Message {
 public:
  ...
  inline bool update_input() const; // == hk made
  ...
  inline bool update_output() const; // == hk made
  ...
  inline bool update_length() const; // == hk made
 ...
 public:
  ...
  inline bool update_total_size() const; // == hk made
  ...
  inline bool update_tag() const; // == hk made
  ...
  inline bool update_source() const; // == hk made
  ...
  inline bool update_value() const; // == hk made
  ...
  inline bool update_file() const; // == hk made
  ...
  inline bool update_from() const; // == hk made
  ...
  inline bool update_handle_uninterpreted() const; // == hk made
  ...
  inline bool update_controller() const; // == hk made
  ...
  inline bool update_already_here() const; // == hk made
  ...
  inline bool update_uint32() const; // == hk made
  ...
  inline bool update_uint64() const; // == hk made
  ...
  inline bool update_string() const; // == hk made
  ...
  inline bool update_memset() const; // == hk made
  ...
  inline bool update_int32() const; // == hk made
  ...
  inline bool update_int64() const; // == hk made
  ...
  inline bool update_cached_size() const; // == hk made
  ...
  inline bool update_extensions() const; // == hk made
  ...
  inline bool update_bit() const; // == hk made
  ...
  inline bool update_bits() const; // == hk made
  ...
  inline bool update_offsets() const; // == hk made
  ...
  inline bool update_reflection() const; // == hk made
  ...
  inline bool update_some_cord() const; // == hk made
 ...
 public:
  ...
  inline bool update_some_string_piece() const; // == hk made
 ...
 public:
  ...
  inline bool update_int_() const; // == hk made
  ...
  inline bool update_friend_() const; // == hk made
  ...
  inline bool update_class_() const; // == hk made
  ...
  inline bool update_do_() const; // == hk made
  ...
  inline bool update_field_type() const; // == hk made
  ...
  inline bool update_is_packed() const; // == hk made
  ...
  inline bool update_release_length() const; // == hk made
  ...
  inline bool update_release_do() const; // == hk made
...
//===================================================
public:
  inline void clear_update_input();	// == hk made
  inline void clear_update_output();	// == hk made
  inline void clear_update_length();	// == hk made
  inline void clear_update_i();	// == hk made
  inline void clear_update_new_element();	// == hk made
  inline void clear_update_total_size();	// == hk made
  inline void clear_update_tag();	// == hk made
  inline void clear_update_source();	// == hk made
  inline void clear_update_value();	// == hk made
  inline void clear_update_file();	// == hk made
  inline void clear_update_from();	// == hk made
  inline void clear_update_handle_uninterpreted();	// == hk made
  inline void clear_update_index();	// == hk made
  inline void clear_update_controller();	// == hk made
  inline void clear_update_already_here();	// == hk made
  inline void clear_update_uint32();	// == hk made
  inline void clear_update_uint64();	// == hk made
  inline void clear_update_string();	// == hk made
  inline void clear_update_memset();	// == hk made
  inline void clear_update_int32();	// == hk made
  inline void clear_update_int64();	// == hk made
  inline void clear_update_cached_size();	// == hk made
  inline void clear_update_extensions();	// == hk made
  inline void clear_update_bit();	// == hk made
  inline void clear_update_bits();	// == hk made
  inline void clear_update_offsets();	// == hk made
  inline void clear_update_reflection();	// == hk made
  inline void clear_update_some_cord();	// == hk made
  inline void clear_update_some_string_piece();	// == hk made
  inline void clear_update_int_();	// == hk made
  inline void clear_update_friend_();	// == hk made
  inline void clear_update_class_();	// == hk made
  inline void clear_update_do_();	// == hk made
  inline void clear_update_field_type();	// == hk made
  inline void clear_update_is_packed();	// == hk made
  inline void clear_update_release_length();	// == hk made
  inline void clear_update_release_do();	// == hk made
};
// -------------------------------------------------------------------
...
inline bool TestConflictingSymbolNames::update_input() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_input() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestConflictingSymbolNames::clear_update_input() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
...
inline bool TestConflictingSymbolNames::update_output() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_output() { // == hk made
  _update_bits_[0] |= 0x00000002u;
}
inline void TestConflictingSymbolNames::clear_update_output() { // == hk made
  _update_bits_[0] &= ~0x00000002u;
}
...
inline bool TestConflictingSymbolNames::update_length() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_length() { // == hk made
  _update_bits_[0] |= 0x00000004u;
}
inline void TestConflictingSymbolNames::clear_update_length() { // == hk made
  _update_bits_[0] &= ~0x00000004u;
}
...
inline bool TestConflictingSymbolNames::update_total_size() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_total_size() { // == hk made
  _update_bits_[0] |= 0x00000020u;
}
inline void TestConflictingSymbolNames::clear_update_total_size() { // == hk made
  _update_bits_[0] &= ~0x00000020u;
}
...
inline bool TestConflictingSymbolNames::update_tag() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_tag() { // == hk made
  _update_bits_[0] |= 0x00000040u;
}
inline void TestConflictingSymbolNames::clear_update_tag() { // == hk made
  _update_bits_[0] &= ~0x00000040u;
}
...
inline bool TestConflictingSymbolNames::update_source() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_source() { // == hk made
  _update_bits_[0] |= 0x00000080u;
}
inline void TestConflictingSymbolNames::clear_update_source() { // == hk made
  _update_bits_[0] &= ~0x00000080u;
}
...
inline bool TestConflictingSymbolNames::update_value() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_value() { // == hk made
  _update_bits_[0] |= 0x00000100u;
}
inline void TestConflictingSymbolNames::clear_update_value() { // == hk made
  _update_bits_[0] &= ~0x00000100u;
}
...
inline bool TestConflictingSymbolNames::update_file() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_file() { // == hk made
  _update_bits_[0] |= 0x00000200u;
}
inline void TestConflictingSymbolNames::clear_update_file() { // == hk made
  _update_bits_[0] &= ~0x00000200u;
}
...
inline bool TestConflictingSymbolNames::update_from() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_from() { // == hk made
  _update_bits_[0] |= 0x00000400u;
}
inline void TestConflictingSymbolNames::clear_update_from() { // == hk made
  _update_bits_[0] &= ~0x00000400u;
}
...
inline bool TestConflictingSymbolNames::update_handle_uninterpreted() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_handle_uninterpreted() { // == hk made
  _update_bits_[0] |= 0x00000800u;
}
inline void TestConflictingSymbolNames::clear_update_handle_uninterpreted() { // == hk made
  _update_bits_[0] &= ~0x00000800u;
}
...
inline bool TestConflictingSymbolNames::update_controller() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_controller() { // == hk made
  _update_bits_[0] |= 0x00002000u;
}
inline void TestConflictingSymbolNames::clear_update_controller() { // == hk made
  _update_bits_[0] &= ~0x00002000u;
}
...
inline bool TestConflictingSymbolNames::update_already_here() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_already_here() { // == hk made
  _update_bits_[0] |= 0x00004000u;
}
inline void TestConflictingSymbolNames::clear_update_already_here() { // == hk made
  _update_bits_[0] &= ~0x00004000u;
}
...
inline bool TestConflictingSymbolNames::update_uint32() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_uint32() { // == hk made
  _update_bits_[0] |= 0x00008000u;
}
inline void TestConflictingSymbolNames::clear_update_uint32() { // == hk made
  _update_bits_[0] &= ~0x00008000u;
}
...
inline bool TestConflictingSymbolNames::update_uint64() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_uint64() { // == hk made
  _update_bits_[0] |= 0x00010000u;
}
inline void TestConflictingSymbolNames::clear_update_uint64() { // == hk made
  _update_bits_[0] &= ~0x00010000u;
}
...
inline bool TestConflictingSymbolNames::update_string() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_string() { // == hk made
  _update_bits_[0] |= 0x00020000u;
}
inline void TestConflictingSymbolNames::clear_update_string() { // == hk made
  _update_bits_[0] &= ~0x00020000u;
}
...
inline bool TestConflictingSymbolNames::update_memset() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_memset() { // == hk made
  _update_bits_[0] |= 0x00040000u;
}
inline void TestConflictingSymbolNames::clear_update_memset() { // == hk made
  _update_bits_[0] &= ~0x00040000u;
}
...
inline bool TestConflictingSymbolNames::update_int32() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_int32() { // == hk made
  _update_bits_[0] |= 0x00080000u;
}
inline void TestConflictingSymbolNames::clear_update_int32() { // == hk made
  _update_bits_[0] &= ~0x00080000u;
}
...
inline bool TestConflictingSymbolNames::update_int64() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_int64() { // == hk made
  _update_bits_[0] |= 0x00100000u;
}
inline void TestConflictingSymbolNames::clear_update_int64() { // == hk made
  _update_bits_[0] &= ~0x00100000u;
}
...
inline bool TestConflictingSymbolNames::update_cached_size() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_cached_size() { // == hk made
  _update_bits_[0] |= 0x00200000u;
}
inline void TestConflictingSymbolNames::clear_update_cached_size() { // == hk made
  _update_bits_[0] &= ~0x00200000u;
}
...
inline bool TestConflictingSymbolNames::update_extensions() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_extensions() { // == hk made
  _update_bits_[0] |= 0x00400000u;
}
inline void TestConflictingSymbolNames::clear_update_extensions() { // == hk made
  _update_bits_[0] &= ~0x00400000u;
}
...
inline bool TestConflictingSymbolNames::update_bit() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_bit() { // == hk made
  _update_bits_[0] |= 0x00800000u;
}
inline void TestConflictingSymbolNames::clear_update_bit() { // == hk made
  _update_bits_[0] &= ~0x00800000u;
}
...
inline bool TestConflictingSymbolNames::update_bits() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_bits() { // == hk made
  _update_bits_[0] |= 0x01000000u;
}
inline void TestConflictingSymbolNames::clear_update_bits() { // == hk made
  _update_bits_[0] &= ~0x01000000u;
}
...
inline bool TestConflictingSymbolNames::update_offsets() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_offsets() { // == hk made
  _update_bits_[0] |= 0x02000000u;
}
inline void TestConflictingSymbolNames::clear_update_offsets() { // == hk made
  _update_bits_[0] &= ~0x02000000u;
}
...
inline bool TestConflictingSymbolNames::update_reflection() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_reflection() { // == hk made
  _update_bits_[0] |= 0x04000000u;
}
inline void TestConflictingSymbolNames::clear_update_reflection() { // == hk made
  _update_bits_[0] &= ~0x04000000u;
}
...
inline bool TestConflictingSymbolNames::update_some_cord() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_some_cord() { // == hk made
  _update_bits_[0] |= 0x08000000u;
}
inline void TestConflictingSymbolNames::clear_update_some_cord() { // == hk made
  _update_bits_[0] &= ~0x08000000u;
}
...
inline bool TestConflictingSymbolNames::update_some_string_piece() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_some_string_piece() { // == hk made
  _update_bits_[0] |= 0x10000000u;
}
inline void TestConflictingSymbolNames::clear_update_some_string_piece() { // == hk made
  _update_bits_[0] &= ~0x10000000u;
}
...
inline bool TestConflictingSymbolNames::update_int_() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_int_() { // == hk made
  _update_bits_[0] |= 0x20000000u;
}
inline void TestConflictingSymbolNames::clear_update_int_() { // == hk made
  _update_bits_[0] &= ~0x20000000u;
}
...
inline bool TestConflictingSymbolNames::update_friend_() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_friend_() { // == hk made
  _update_bits_[0] |= 0x40000000u;
}
inline void TestConflictingSymbolNames::clear_update_friend_() { // == hk made
  _update_bits_[0] &= ~0x40000000u;
}
...
inline bool TestConflictingSymbolNames::update_class_() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_class_() { // == hk made
  _update_bits_[0] |= 0x80000000u;
}
inline void TestConflictingSymbolNames::clear_update_class_() { // == hk made
  _update_bits_[0] &= ~0x80000000u;
}
...
inline bool TestConflictingSymbolNames::update_do_() const { // == hk made
...
inline void TestConflictingSymbolNames::set_update_do_() { // == hk made
  _update_bits_[1] |= 0x00000001u;
}
inline void TestConflictingSymbolNames::clear_update_do_() { // == hk made
  _update_bits_[1] &= ~0x00000001u;
}
...
inline bool TestConflictingSymbolNames::update_field_type() const { // == hk made
  return (_update_bits_[1] & 0x00000002u) != 0;
}
...
inline void TestConflictingSymbolNames::set_update_field_type() { // == hk made
  _update_bits_[1] |= 0x00000002u;
}
inline void TestConflictingSymbolNames::clear_update_field_type() { // == hk made
  _update_bits_[1] &= ~0x00000002u;
}
...
inline bool TestConflictingSymbolNames::update_is_packed() const { // == hk made
  return (_update_bits_[1] & 0x00000004u) != 0;
}
...
inline void TestConflictingSymbolNames::set_update_is_packed() { // == hk made
  _update_bits_[1] |= 0x00000004u;
}
inline void TestConflictingSymbolNames::clear_update_is_packed() { // == hk made
  _update_bits_[1] &= ~0x00000004u;
}
...
inline bool TestConflictingSymbolNames::update_release_length() const { // == hk made
  return (_update_bits_[1] & 0x00000008u) != 0;
}
...
inline void TestConflictingSymbolNames::set_update_release_length() { // == hk made
  _update_bits_[1] |= 0x00000008u;
}
inline void TestConflictingSymbolNames::clear_update_release_length() { // == hk made
  _update_bits_[1] &= ~0x00000008u;
}
...
inline bool TestConflictingSymbolNames::update_release_do() const { // == hk made
  return (_update_bits_[1] & 0x00000010u) != 0;
}
...
inline void TestConflictingSymbolNames::set_update_release_do() { // == hk made
  _update_bits_[1] |= 0x00000010u;
}
inline void TestConflictingSymbolNames::clear_update_release_do() { // == hk made
  _update_bits_[1] &= ~0x00000010u;
}
