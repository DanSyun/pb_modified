...
inline bool PublicImportMessage::update_e() const { // == hk made
...
inline void PublicImportMessage::set_update_e() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void PublicImportMessage::clear_update_e() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
