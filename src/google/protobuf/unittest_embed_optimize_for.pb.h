...
inline bool TestEmbedOptimizedForSize::update_optional_message() const { // == hk made
...
inline void TestEmbedOptimizedForSize::set_update_optional_message() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestEmbedOptimizedForSize::clear_update_optional_message() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
