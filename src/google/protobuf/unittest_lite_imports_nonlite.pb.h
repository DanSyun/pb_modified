...
inline bool TestLiteImportsNonlite::update_message() const { // == hk made
...
inline void TestLiteImportsNonlite::set_update_message() { // == hk made
  _update_bits_[0] |= 0x00000001u;
}
inline void TestLiteImportsNonlite::clear_update_message() { // == hk made
  _update_bits_[0] &= ~0x00000001u;
}
