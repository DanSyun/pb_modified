...
// =============== hk made =================
void TestMessageSet::ClearUpdateBits() {
...
// =============== hk made =================
void TestMessageSetContainer::ClearUpdateBits() {
  ::memset(_update_bits_, 0, sizeof(_update_bits_));
}
...
// =============== hk made =================
void TestMessageSetExtension1::ClearUpdateBits() {
  ::memset(_update_bits_, 0, sizeof(_update_bits_));
}
...
// =============== hk made =================
void TestMessageSetExtension2::ClearUpdateBits() {
  ::memset(_update_bits_, 0, sizeof(_update_bits_));
}
...
// =============== hk made =================
void RawMessageSet_Item::ClearUpdateBits() {
  ::memset(_update_bits_, 0, sizeof(_update_bits_));
}
...
// =============== hk made =================
void RawMessageSet::ClearUpdateBits() {
  ::memset(_update_bits_, 0, sizeof(_update_bits_));
}
